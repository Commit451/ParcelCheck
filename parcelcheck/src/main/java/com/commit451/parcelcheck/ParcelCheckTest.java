...
/**
 * Test which checks parcel models by their class to assure that it is parcelable. Override and
 * provide the array of classes you want checked
 */
public abstract class ParcelCheckTest extends AndroidTestCase {
     ...
     */
    public abstract Class[] getClassesToCheck();
